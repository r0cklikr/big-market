package cn.bugstack.domain.activity.service.quata.rule.impl;
...
import cn.bugstack.domain.activity.service.quata.rule.AbstractActionChain;
...
public class ActivitySkuStockActionChain extends AbstractActionChain {
    ...
    public boolean action(ActivitySkuEntity activitySkuEntity, ActivityEntity activityEntity, ActivityCountEntity activityCountEntity) {
        ...
        // 扣减库存 虽然前面判断了缓存中库存有剩余(这里的库存是最新的),但是可能很多线程都通过了判定，但是库存实际是不够的，那么就需要加锁
